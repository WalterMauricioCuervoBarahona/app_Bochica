...
@NamedQueries({
    @NamedQuery(name = "Enfermedad.obtenerTodos", query = "select e from Historial e")
})
public class Enfermedad {
     ...
     * @generated 0--1-true
     */
    @ManyToMany(cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch = javax.persistence.FetchType.LAZY)
